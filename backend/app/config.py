...
LIVING_POPULATION_COMPACT_SCHEMA_VERSION: Final = 2
LIVING_POPULATION_COMPACT_QUERY_VERSION: Final = (
    "oa-22784-cp949-cell-fragments-json-v2"
)
LIVING_POPULATION_COMPACT_DECIMAL_PRECISION: Final = 38
LIVING_POPULATION_COMPACT_DECIMAL_SCALE: Final = 5
...
PURPOSE_OD_STABILITY_REPORT_VERSION: Final = "v1-purpose-od-stability-pilot"
PURPOSE_OD_STABILITY_HOURS: Final = (8, 14, 18)
PURPOSE_OD_SEOUL_ZONE_COUNT: Final = 427
PURPOSE_OD_STABILITY_MIN_WEEKLY_DATES: Final = 4
PURPOSE_OD_STABILITY_NET_MEDIAN_MIN: Final = 0.80
PURPOSE_OD_STABILITY_NET_MIN_MIN: Final = 0.60
PURPOSE_OD_STABILITY_NET_CONDITIONAL_MEDIAN_MIN: Final = 0.60
PURPOSE_OD_STABILITY_NET_CONDITIONAL_MIN: Final = 0.50
PURPOSE_OD_STABILITY_FLOW_MEDIAN_MIN: Final = 0.85
PURPOSE_OD_STABILITY_DECILE_FRACTION: Final = 0.10
PURPOSE_OD_STABILITY_DECILE_JACCARD_MIN: Final = 0.50
PURPOSE_OD_STABILITY_PURPOSE_JSD_MEDIAN_MAX: Final = 0.05
PURPOSE_OD_STABILITY_PURPOSE_JSD_P90_MAX: Final = 0.10
PURPOSE_OD_STABILITY_VECTOR_COVERAGE_MIN: Final = 0.95
PURPOSE_OD_STABILITY_VECTOR_STRENGTH_MIN: Final = 0.20
PURPOSE_OD_STABILITY_VECTOR_ELIGIBLE_RATIO_MIN: Final = 0.20
PURPOSE_OD_STABILITY_VECTOR_ANGLE_MEDIAN_MAX_DEG: Final = 30.0
PURPOSE_OD_STABILITY_VECTOR_ANGLE_P90_MAX_DEG: Final = 75.0
...
LIVING_OD_SAME_DAY_REPORT_VERSION: Final = "v2-living-od-same-day-screen"
LIVING_OD_SAME_DAY_DATE: Final = "2026-06-30"
LIVING_OD_SAME_DAY_HOURS: Final = (8, 14, 18)
LIVING_OD_SAME_DAY_MASK_IMPUTATIONS: Final = (0.0, 2.0, 3.0)
LIVING_OD_SAME_DAY_PRIMARY_MASK_IMPUTATION: Final = 2.0
LIVING_OD_SAME_DAY_ABSENCE_IMPUTATIONS: Final = (0.0, 2.0, 3.0)
LIVING_OD_SAME_DAY_PRIMARY_ABSENCE_IMPUTATION: Final = 0.0
